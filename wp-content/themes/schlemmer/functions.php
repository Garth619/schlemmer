...
-------------------------------------------------------------- */
 ...
 function load_my_styles_scripts() {
     // Load my stylesheet
     wp_enqueue_style( 'styles', get_template_directory_uri() . '/style.css', '', 11, 'all' ); 
     ...
     if(!is_front_page()) {
     		...
     		wp_enqueue_script( 'jquery-homepage', get_template_directory_uri() . '/js/internals-min.js', array('jquery'), '', true );
