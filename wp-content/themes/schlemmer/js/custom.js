...
// Testimonials
	...
	$('.testimonial_slideshow').slick({
  	infinite: true,
		...
		dots:false,
		fade:true,
		slide:'.single_testimonial_slide',
		prevArrow:'.next_back_wrapper .prev',
...
$('.sticky_get_started_tab, span.get_started_button, span.get_cta, span.ready_cta_mobile, .menu_get_started').on('click', function(e) {
...
$('.sticky_overlay_close').on('click', function(e) {
